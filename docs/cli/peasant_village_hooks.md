## peasant village hooks

Install, inspect, and remove the repository's village upload hooks
...
* [peasant village hooks install](peasant_village_hooks_install.md)	 - Install a village upload hook for the named git events
* [peasant village hooks status](peasant_village_hooks_status.md)	 - Report the village upload hook state of a repository
* [peasant village hooks uninstall](peasant_village_hooks_uninstall.md)	 - Remove the village upload hooks Peasant installed
