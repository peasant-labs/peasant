...
To load completions in your current shell session:
	...
	source <(peasant completion zsh)

To load completions for every new session, execute once:

#### Linux:

	peasant completion zsh > "${fpath[1]}/_peasant"

#### macOS:

	peasant completion zsh > $(brew --prefix)/share/zsh/site-functions/_peasant

You will need to start a new shell for this setup to take effect.


```
peasant completion zsh [flags]
```
