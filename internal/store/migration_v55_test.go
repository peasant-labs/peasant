...
func TestMigrationV55DoesNotInventRetainedEvidence(t *testing.T) {
	t.Parallel()
	var fixture struct {
	...
	defer conn.Close()
	frozen := sqlitemigration.Schema{Migrations: dbSchema.Migrations[:54], MigrationOptions: dbSchema.MigrationOptions[:54]}
