...
func TestMigrationV52PreservesHistoryWithoutInputProof(t *testing.T) {
	t.Parallel()
	...
	defer conn.Close()
	frozen := sqlitemigration.Schema{Migrations: dbSchema.Migrations[:51], MigrationOptions: dbSchema.MigrationOptions[:51]}
