	...
	for _, fixture := range fixtures.Cases {
		...
		t.Run(fixture.Name, func(t *testing.T) {
			...
			for i, size := range fixture.Bytes {
				...
				parsed = append(parsed, indexParseResult{im: indexedMeta{session: DiscoveredSession{SessionID: id, Harness: HarnessClaudeCode}}, entries: []schema.SessionEntry{{SessionID: id, ContentPreview: &text}}, fullContent: true})
			}
